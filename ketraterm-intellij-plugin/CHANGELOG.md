...
- Fixed long combining sequences and joined emoji splitting or losing text during streamed output. Excessively long sequences now have a consistent limit.
