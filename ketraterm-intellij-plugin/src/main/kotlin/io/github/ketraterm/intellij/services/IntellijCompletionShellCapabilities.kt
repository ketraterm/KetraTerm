...
/** Maps authoritative IntelliJ terminal profiles to implemented lexical policy. */
internal fun TerminalProfileKind.intellijCompletionShellCapabilities(): TerminalShellCapabilities =
    when (this) {
