...
@Fork(1)
open class TerminalBufferBenchmark : io.github.ketraterm.render.api.TerminalRenderFrameConsumer {
    @Param("80", "120", "240")
    var width: Int = 0
    ...
    private lateinit var reader: io.github.ketraterm.render.api.TerminalRenderFrameReader
    ...
    open fun setup() {
        ...
        reader = buffer as io.github.ketraterm.render.api.TerminalRenderFrameReader
    ...
    override fun accept(frame: io.github.ketraterm.render.api.TerminalRenderFrame) {
        if (runSingleRowOnly) {
...
@Measurement(iterations = 5, time = 1, timeUnit = TimeUnit.SECONDS)
@Fork(1)
open class TerminalBufferAttributeBenchmark : io.github.ketraterm.render.api.TerminalRenderFrameConsumer {
...
@Measurement(iterations = 5, time = 1, timeUnit = TimeUnit.SECONDS)
@Fork(1)
open class TerminalBufferClusterBenchmark : io.github.ketraterm.render.api.TerminalRenderFrameConsumer {
    @Param("0", "1", "100")
