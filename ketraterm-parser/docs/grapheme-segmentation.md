...
The `jvterm-parser` module handles UTF-8 byte stream decoding and Unicode grapheme cluster assembly using a custom, allocation-free streaming pipeline.

---

## 1. Streaming UTF-8 Decoder (`Utf8Decoder`)

The [Utf8Decoder](file:///c:/Users/gagik/IdeaProjects/terminal-buffer/jvterm-parser/src/main/kotlin/io/github/jvterm/parser/utf8/Utf8Decoder.kt) accepts raw bytes one at a time and reconstructs Unicode codepoints without heap allocations.
...
To resolve this, the [GraphemeAssembler](file:///c:/Users/gagik/IdeaProjects/terminal-buffer/jvterm-parser/src/main/kotlin/io/github/jvterm/parser/unicode/GraphemeAssembler.kt) provides a bifurcated emission model:
