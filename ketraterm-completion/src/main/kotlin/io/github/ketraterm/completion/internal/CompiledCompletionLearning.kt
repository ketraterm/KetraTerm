...
/** Snapshot-owned compiled indexes used by both candidate recovery and ranking. */
internal class CompiledCompletionLearning(
    private val snapshot: TerminalCommandCompletionStatsSnapshot,
) {
